 ...
 * Generated at: 2019-08-27 08:28:39 UTC
...
String path = request.getContextPath();
      ...
      out.write("<div class=\"login-form\" id=\"loginDiv\">\r\n");
      ...
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div style=\"margin-bottom: 20px;float: right;padding-right: 20px;font-size: 18px\">\r\n");
      out.write("            <a style=\"color: #e0bacb\" id=\"res\" onclick=\"toRegister()\">还没帐号？请注册</a>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"register-form\" style=\"display: none\" id=\"registerDiv\">\r\n");
      out.write("    <div class=\"clear\"> </div>\r\n");
      out.write("    <div class=\"avtar\"><img src=\"");
      out.print(path);
      out.write("/static/source/img/avtar.png\" /></div>\r\n");
      ...
      out.write("        <div class=\"key\">\r\n");
      out.write("            <input type=\"text\" id=\"New_username\" name=\"userid\" placeholder=\"请输入账号\" >\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"key\">\r\n");
      out.write("            <input type=\"password\" id=\"New_password\" style=\"margin-bottom: 0px\" name=\"password\" placeholder=\"请输入密码\">\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"key\">\r\n");
      out.write("            <input type=\"password\" id=\"Rel_password\" name=\"password1\" placeholder=\"请确认密码\">\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div style=\"margin-bottom: 20px;float: right;padding-right: 20px;font-size: 18px\">\r\n");
      out.write("            <a href=\"\" style=\"color: #e0bacb\">已有帐号？请登录</a>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"signin\">\r\n");
      out.write("            <input type=\"submit\" id=\"register\" value=\"注册\" >\r\n");
      out.write("        </div>\r\n");
      out.write("    </form>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      ...
      out.write("            $('#submit').attr('value','登录').css('background','#3ea751');\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    /**\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("        var username = $('#New_username').val();\r\n");
      out.write("        var psaaword1 = $('#New_password').val();\r\n");
      out.write("        var password2 = $('#Rel_password').val();\r\n");
      out.write("        if(isNull(username) && isNull(psaaword1)){\r\n");
      out.write("            $('#register').attr('value','请输入账号和密码!!!').css('background','red');\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        if(isNull(username)){\r\n");
      out.write("            $('#register').attr('value','请输入账号!!!').css('background','red');\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        if(isNull(psaaword1)){\r\n");
      out.write("            $('#register').attr('value','请输入密码!!!').css('background','red');\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        if ((psaaword1).equals(password2)){\r\n");
      out.write("            $('#register').attr('value','两次密码不一致!!!').css('background','red');\r\n");
      out.write("            return false;\r\n");
      out.write("        }\r\n");
      out.write("        //if(username != 'Amaya' || password != '123456'){\r\n");
      out.write("        //\t$('#submit').attr('value','账号或密码错误!!!').css('background','red');\r\n");
      ...
      out.write("        //}\r\n");
      out.write("        else{\r\n");
      out.write("            $('#register').attr('value','register~');\r\n");
      out.write("            return true;\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/login.jsp(68,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
